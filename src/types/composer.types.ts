...
export interface PostRecord {
  ...
  /**
   * Sibling-row group id when the post was generated by the multi-network
   * composer (v0.3.9+). Posts with the same group_id were created together
   * from the same brief and target different networks. NULL on legacy
   * mono-network rows. The dashboard / calendar surfaces a "Groupe" badge
   * when this is set.
   */
